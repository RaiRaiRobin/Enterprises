 <footer class="footer">
        <div class="container-fluid">
          <nav class="float-left">
            <ul>
              <li>
                <a href="#">
                  Green Nepal Multicare Provision
                </a>
              </li>
              <li>
                <a href="#">
          ...
          <div class="copyright float-right">
            ...
            <a href="#" target="_blank">GNMP</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
      ...
      <ul class="dropdown-menu">
        ...
        <li class="active">
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{asset('material-dashboard/assets/img/sidebar-1.jpg')}}" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{asset('material-dashboard/assets/img/sidebar-2.jpg')}}" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{asset('material-dashboard/assets/img/sidebar-3.jpg')}}" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{asset('material-dashboard/assets/img/sidebar-4.jpg')}}" alt="">
          </a>
        </li>
  ...
  <script src="{{asset('material-dashboard/assets/js/material-dashboard.js?v=2.1.1')}}" type="text/javascript"></script>
  <!-- Material Dashboard DEMO methods, don't include it in your project! -->
  <script src="{{asset('material-dashboard/assets/demo/demo.js')}}"></script>
  <script type="text/javascript" src="{{asset('js/boardCustom.js')}}"></script>
  <script>
