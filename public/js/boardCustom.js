...
$(document).ready(function() {
    ...
    $(document).on('click', '#openAddLeaderAjaxButton', function(e) {
        e.preventDefault();
        $.ajax({
            url: '/board/page/register/leader',
            method: 'GET',
            beforeSend: function() {
...
$(document).ready(function() {
    ...
    $(document).on('click', '#openAddDealerAjaxButton', function(e) {
        e.preventDefault();
        $.ajax({
            url: '/board/page/register/dealer',
            method: 'GET',
            beforeSend: function() {
